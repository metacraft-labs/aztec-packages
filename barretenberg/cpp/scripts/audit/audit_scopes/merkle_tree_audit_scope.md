...
### Storage Layer (module `crypto_merkle_tree_lmdb`)
6. `crypto/merkle_tree_lmdb/lmdb_store/lmdb_tree_store.hpp`
7. `crypto/merkle_tree_lmdb/lmdb_store/lmdb_tree_store.cpp`

### Node Store (Cache + Metadata)
8. `crypto/merkle_tree_lmdb/node_store/cached_content_addressed_tree_store.hpp`
9. `crypto/merkle_tree/node_store/content_addressed_cache.hpp`
10. `crypto/merkle_tree/node_store/tree_meta.hpp`

### Append-Only Tree
11. `crypto/merkle_tree_lmdb/append_only_tree/content_addressed_append_only_tree.hpp`

### Indexed Tree
12. `crypto/merkle_tree_lmdb/indexed_tree/content_addressed_indexed_tree.hpp`
...
2. `crypto/merkle_tree_lmdb/lmdb_store/lmdb_tree_store.test.cpp`
3. `crypto/merkle_tree/node_store/content_addressed_cache.test.cpp`
4. `crypto/merkle_tree_lmdb/append_only_tree/content_addressed_append_only_tree.test.cpp`
5. `crypto/merkle_tree_lmdb/indexed_tree/content_addressed_indexed_tree.test.cpp`
6. `crypto/merkle_tree/nullifier_tree/nullifier_memory_tree.test.cpp`
...
- `crypto/merkle_tree_lmdb/test_fixtures.hpp` — GTest assertion wrappers for tree state verification.
